/* =============================================================
   AERION — Climate Control · Interactions
   Bespoke JS for HVAC service / repair site.
...
(function () {
  ...
  /* --- Scroll reveal (reveal / gauge / emergency) --- */
  ...
  /* --- Gauge needle animation (hero) --- */
  var gauge = document.querySelector('.gauge');
  if (gauge && !reducedMotion) {
    var needle = gauge.querySelector('.gauge-needle');
    if (needle) {
      // Start at 72° (optimal) — rotate from center
